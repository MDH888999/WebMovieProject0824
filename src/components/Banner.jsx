...
import IconRatingHelf from "../assets/rating-half.png";
        ...
        <div className="w-full h-full flex items-center justify-center space-x-[50px] p-12 relative z-20">
            <div className=" flex flex-col space-y-5 items-baseline w-[50%]">
                ...
                <div className=" flex flex-col items-space-y-4">
                    ...
                    <div className="flex items-center space-x-3 mb-2">
                        ...
                        <img src={IconRating} alt="iconRating" className="w-8 h-8" />
                        <img src={IconRating} alt="iconRating" className="w-8 h-8" />
                        <img src={IconRatingHelf} alt="iconRatingHalf" className="w-8 h-8" />
                    </div>
            ...
            <div className="w-[50%] flex items-center justify-center">
                <div className="w-[300px] h-[400px] relative group cursor-pointer">
                    <img src={ImgTemp} alt="tempImages" className="w-full h-full object-cover" />
